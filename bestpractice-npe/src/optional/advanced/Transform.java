...
public class Transform {
    public static void main(String[] args) {
        ...
        //Adopt
        String uppernameStr = lowername.map(String::toUpperCase).get();    
        
        }

        //The flatMap()method takes a function argument that is applied to anOptionalvalue, and then returns the result directly.
